...
module.exports.parseUPSStatus = (body) => {
  ...
  result.values = {
    ...
    battery: filled(body['battery.charge']) ? parseInt(body['battery.charge'], 10) : null,
    ...
    measure_power: filled(body['ups.load']) ? ( parseInt(body['ups.load']) / 100 * parseInt(body['ups.realpower.nominal']) ) : null,
